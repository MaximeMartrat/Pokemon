...
<?php if(isset($_SESSION['random'])): ?>
    <style>#joueur1_container{ display:block; }
            #solo{ display:none; } </style>
<?php elseif(isset($_SESSION['joueur2'])): ?>
    <style>#joueur1_container, #joueur_container2{ display:block; }
    #solo, #duo{ display: none; }</style>
<?php else: ?>
    <style>#joueur1_container, #joueur_container2{ display:none; }
    #solo, #duo{ display: block; }</style>
<?php endif; ?>
<div id="loggin_container">
    <div id="select_play">
        ...
        <?php if(isset($_SESSION['joueur1'])): ?>
            <h2><?= strtoupper($_SESSION['joueur1']) ?></h2>
        <? else : ?>
            <h2>J1</h2>
        <?php endif; ?>
        ...
        <?php if (isset($_SESSION['joueur2'])): ?>
            <h2><?= strtoupper($_SESSION['joueur2']) ?></h2>
            <?php if(isset($_SESSION['random'])){
